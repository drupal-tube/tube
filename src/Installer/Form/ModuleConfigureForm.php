...
namespace Drupal\tube\Installer\Form;

use Drupal\Core\Config\ConfigFactoryInterface;
use Drupal\Core\Form\ConfigFormBase;
use Drupal\Core\Form\FormStateInterface;
use Drupal\tube\OptionalModulesManager;
...
class ModuleConfigureForm extends ConfigFormBase {
   ...
   * The plugin manager.
   *
   * @var \Drupal\tube\OptionalModulesManager
   */
   ...
   * @param \Drupal\tube\OptionalModulesManager $optionalModulesManager
   *   The factory for configuration objects.
   */
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      ...
      $container->get('plugin.manager.tube.optional_modules')
    );
  }
  ...
  public function getFormId() {
    return 'tube_module_configure_form';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $install_state[0]['tube_additional_modules'] = $installModules;
